...
import { FiSearch, FiArrowRight, FiDatabase, FiClock, FiFilter } from 'react-icons/fi';
...
const OrganisasiPage = () => {
  ...
  const organizations = [
    ...
    },
    {
      ...
      logo: "/icons/edu-icon.svg",
      datasets: 36,
      updated: "1 minggu lalu",
      sector: "PENDIDIKAN",
      description: "Bertanggung jawab atas pengelolaan pendidikan di kota Parepare",
      contact: "0411-2345678",
      website: "dikbud.parepare.go.id"
    },
    {
      id: 3,
    ...
    <Layout>
      <div className="bg-gradient-to-b from-[#e8f1ff] to-[#d6e6ff] min-h-screen pb-20">
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-20">
          {/* Search - Updated to match MetadataPage */}
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-5 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center">
              <div className="flex items-center mb-3 sm:mb-0">
                ...
                <h2 className="font-bold text-[#02033b] text-xl">
                  {filteredOrgs.length} Organisasi Ditemukan
                </h2>
              </div>
                  ...
                  >
                    <div className="p-6 h-full flex flex-col">
                      <div className="flex items-start mb-5">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-[#02033b] group-hover:text-[#3a9ec9] mb-2 cursor-pointer transition-colors">{org.name}</h3>
